...
public class ZuoyepigaiServiceImpl extends ServiceImpl<ZuoyepigaiDao, ZuoyepigaiEntity> implements ZuoyepigaiService {
    ...
    @Override
    public List<Map<String, Object>> chengjiSectionStat(Map<String, Object> params, Wrapper<ZuoyepigaiEntity> wrapper) {
        return baseMapper.chengjiSectionStat(params, wrapper);
    }
